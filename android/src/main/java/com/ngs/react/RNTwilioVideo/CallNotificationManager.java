...
public class CallNotificationManager {
    ...
    public void createIncomingCallNotification(Context context,
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, VIDEO_CHANNEL)
                ...
                .setContentTitle(sharedPref.getString(LocalizedKeys.INCOMING_VIDEO_CALL, "Incoming video call"))
                .setContentText(callInvite.getFrom(" / ", sharedPref) + sharedPref.getString(LocalizedKeys.IS_CALLING, "is calling"))
